...
|---------|--------|----------|
| **AlloyTime** | phase 1 — in design | Time/TimeZone/TimeMachine models (no views): mock-clock state machine, IANA + fixed-offset zone resolution, zone→country/city/GMT metadata |
