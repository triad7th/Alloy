...
/// Shared fixture data for DSP twin tests (PatchTests, VoiceTests).
/// Copied verbatim from web src/dsp/testing/fixtures.ts (FIXTURE_PATCH_JSON).
let fixturePatchJSON = """
{
  "schemaVersion": 1,
